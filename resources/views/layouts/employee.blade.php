@php
    $notifications = \App\Http\Controllers\NotificationConstroller::latestNotifications();
@endphp
<!doctype html>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                            ...
                                            @forelse ($notifications as $notification)
                                                <a class="dropdown-item d-flex align-items-center"
                                                    ...
                                                    <div><span
                                                            class="small text-gray-500">{{ $notification->created_at->diffForHumans() }}</span>
                                            ...
                                            @empty
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <div><span class="small text-gray-500">December 12, 2019</span>
                                                        <p>No Notifcation Available</p>
                                                    </div>
                                                </a>
                                            @endforelse
                                            <a class="dropdown-item text-center small text-gray-500" href="{{route('notifications.my')}}">
